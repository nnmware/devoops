...
<h3 class="page-header">Example: Stacked-to-horizontal</h3>
<p>Using a single set of <code>.col-md-*</code> grid classes, you can create a basic grid system that starts out stacked
	...
	devices. Place grid columns in any <code>.row</code>.
</p>
...
<h3 class="page-header">Example: Mobile and desktop</h3>
...
<h3 class="page-header">Example: Mobile, tablet, desktops</h3>
...
<h3 class="page-header">Offsetting columns</h3>
...
<h3 class="page-header">Nesting columns</h3>
<p>To nest your content with the default grid, add a new <code>.row</code> and set of <code>.col-md-*</code> columns
	within an existing <code>.col-md-*</code> column. Nested rows should include a set of columns that add up to 12 or
	less.</p>
<div class="container-fluid">
	<div class="row show-grid">
		<div class="col-md-9">
...
<h3 class="page-header">Column ordering</h3>
