...
<div class="row">
	<div class="col-xs-12 col-sm-6">
		<div class="box">
			...
			<div id="map-1" class="box-content" style="height: 300px;">
			</div>
		</div>
	</div>
	<div class="col-xs-12 col-sm-6">
		<div class="box">
			...
			<div id="map-2" class="box-content" style="height: 300px;">
			</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
		<div class="box">
			...
			<div id="map-3" class="box-content" style="height: 400px;">
			</div>
		</div>
	</div>
</div>
